...
function Navbar(props){
    ...
    <NavLink className="navbar-brand" to="/">NewsEra</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li className="nav-item"><NavLink className="nav-link" to="/bussiness">Bussiness</NavLink></li>
        <li className="nav-item"><NavLink className="nav-link" to="/entertentment">Entertentment</NavLink></li>
